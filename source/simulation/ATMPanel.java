...
class ATMPanel extends Panel
{
     ...
     */
    ATMPanel(final GUI gui,Map<Component, Component> atmPanelData)
    {
        ...
        add(atmPanelData.get("operatorPanel"));
        atmLayout.setConstraints(atmPanelData.get("operatorPanel"),
        ...
        cardReaderPanel.add(atmPanelData.get("cardReader"));
        add(cardReaderPanel);
        ...
        add(atmPanelData.get("display"));
        atmLayout.setConstraints(atmPanelData.get("display"), 
                GUI.makeConstraints(DISPLAY_ROW, DISPLAY_COL,
                                DISPLAY_WIDTH, DISPLAY_HEIGHT,
                                DISPLAY_FILL));
                                
        add(atmPanelData.get("keyboard"));
        atmLayout.setConstraints(atmPanelData.get("keyboard"),
        ...
        add(atmPanelData.get("cashDispenser"));
        atmLayout.setConstraints(atmPanelData.get("cashDispenser"),
        ...
        envelopeAcceptorPanel.add(atmPanelData.get("envelopeAcceptor"));
        ...
        atmLayout.setConstraints(envelopeAcceptorPanel,
                GUI.makeConstraints(ENVELOPE_ROW, ENVELOPE_COL, 
                                ...
                                ENVELOPE_FILL));
        atmPanelData.get("envelopeAcceptor").setVisible(false);
        
        // Add the receipt printer
        
        add(atmPanelData.get("receiptPrinter"));
        atmLayout.setConstraints(atmPanelData.get("receiptPrinter"),
        ...
        showLogButtonPanel.setBackground(atmPanelData.get("operatorPanel").getBackground());
